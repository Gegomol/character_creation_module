...
def attack(char_name: str, char_class: str) -> str:
    ...
    if char_class == 'mage':
        kick2: int = 5 + randint(5, 10)
        return (f'{char_name} нанёс урон противнику равный {kick2}')
    if char_class == 'healer':
        kick3: int = 5 + randint(-3, -1)
        return (f'{char_name} нанёс урон противнику равный {kick3}')
...
def defence(char_name: str, char_class: str) -> str:
    ...
    if char_class == 'mage':
        block2: int = 10 + randint(-2, 2)
        return (f'{char_name} блокировал {block2} урона')
    if char_class == 'healer':
        block3: int = 10 + randint(2, 5)
        return (f'{char_name} блокировал {block3} урона')
...
def special(char_name: str, char_class: str) -> str:
    ...
    if char_class == 'warrior':
        ...
        return (f'{char_name} применил специальное умение '
                f'«Выносливость {special1}»')
    if char_class == 'mage':
        special2: int = 45
        return (f'{char_name} применил специальное умение «Атака {special2}»')
    if char_class == 'healer':
        special3: int = 40
        return (f'{char_name} применил специальное умение «Защита {special3}»')
